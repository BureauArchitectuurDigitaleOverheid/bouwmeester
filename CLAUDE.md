...
The frontend asks rights through `POST /api/authz/evaluations` (AuthZEN-shaped batch over `can()`, subject is always the caller) instead of deriving them from roles.
