          ...
          <div className="space-y-6">
            ...
            {node.node_type === NodeType.BRON && (
              <Card>
                ...
                {bijlageInfo ? (
                  <div className={`flex items-center justify-between p-3 rounded-lg border border-border bg-gray-50/50 ${bijlageInfo.bestand_beschikbaar === false ? 'opacity-50' : ''}`}>
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        {bijlageInfo.bestand_beschikbaar === false ? (
