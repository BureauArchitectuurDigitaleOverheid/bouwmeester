"""Temporal parent records for OrganisatieEenheid."""
...
class OrganisatieEenheidParent(Base):
    __tablename__ = "organisatie_eenheid_parent"
    ...
    eenheid: Mapped["OrganisatieEenheid"] = relationship(
        ...
        foreign_keys=[eenheid_id],
    )
    parent: Mapped["OrganisatieEenheid"] = relationship(
        "OrganisatieEenheid",
