...
def upgrade() -> None:
    ...
    op.create_table('corpus_node',
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('node_type', sa.String(), nullable=False, comment='dossier|doel|instrument|beleidskader|maatregel|politieke_input'),
    ...
    op.create_table('beleidskader',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('scope', sa.String(), nullable=False, comment='nationaal|eu|internationaal'),
    ...
    op.create_table('doel',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('type', sa.String(), nullable=False, comment='politiek|organisatorisch|operationeel'),
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('fase', sa.String(), nullable=False, comment='verkenning|beleidsvorming|uitvoering|evaluatie'),
    sa.Column('eigenaar', sa.String(), nullable=True),
    sa.Column('deadline', sa.Date(), nullable=True),
    sa.Column('prioriteit', sa.String(), server_default='normaal', nullable=False, comment='laag|normaal|hoog|kritiek'),
    sa.ForeignKeyConstraint(['id'], ['corpus_node.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['from_node_id'], ['corpus_node.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['to_node_id'], ['corpus_node.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('instrument',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('type', sa.String(), nullable=False, comment='wetgeving|subsidie|voorlichting|handhaving|overig'),
    sa.Column('rechtsgrondslag', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['corpus_node.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('maatregel',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    op.create_table('node_stakeholder',
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('node_id', sa.UUID(), nullable=False),
    sa.Column('person_id', sa.UUID(), nullable=False),
    sa.Column('rol', sa.String(), nullable=False, comment='eigenaar|betrokken|adviseur'),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['node_id'], ['corpus_node.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['person_id'], ['person.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('politieke_input',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('type', sa.String(), nullable=False, comment='coalitieakkoord|motie|kamerbrief|toezegging|amendement'),
    sa.Column('referentie', sa.String(), nullable=True, comment='e.g. kamerstuknummer'),
    sa.Column('datum', sa.Date(), nullable=True),
    sa.Column('status', sa.String(), server_default='open', nullable=False, comment='open|in_behandeling|afgedaan'),
    sa.ForeignKeyConstraint(['id'], ['corpus_node.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.String(), server_default='open', nullable=False, comment='open|in_progress|done|cancelled'),
    sa.Column('priority', sa.String(), server_default='normaal', nullable=False, comment='laag|normaal|hoog|kritiek'),
    sa.Column('deadline', sa.Date(), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('person_id', sa.UUID(), nullable=False),
    sa.Column('rol', sa.String(), server_default='lid', nullable=False, comment='lid|coordinator'),
    sa.ForeignKeyConstraint(['person_id'], ['person.id'], ondelete='CASCADE'),
    ...
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('event_type', sa.String(), nullable=False, comment='node.created|node.updated|edge.created|edge.deleted|task.created|task.assigned|task.completed|stakeholder.added'),
    ...
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('person_id', sa.UUID(), nullable=False),
    sa.Column('type', sa.String(), nullable=False, comment='task_assigned|task_overdue|node_updated|edge_created|coverage_needed'),
    sa.Column('title', sa.String(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['person_id'], ['person.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['related_node_id'], ['corpus_node.id'], ondelete='SET NULL'),
