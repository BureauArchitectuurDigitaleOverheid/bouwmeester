...
async def seed(db: AsyncSession) -> None:
    ...
    # =========================================================================
    # INITIATIEVEN + LEADS (mock data, see scripts/seed_initiatieven.py)
    # =========================================================================
    from seed_initiatieven import seed_initiatieven

    await seed_initiatieven(db, owner=first_person)
